...
% Rules
        rules1 = ["deltaT==chico & Horario==B => deltaSetPoint=bajale",... 
            ...
            "deltaT==grande & Horario==P => deltaSetPoint=dejale"];
...
% Inputs
    ...
    fis2 = addInput(fis2,[18 26],'Name','Comfort');
            fis2 = addMF(fis2,"Comfort","zmf",[ 20 21],"Name","frio");
...
% Rules
        rules2 = ["Comfort==frio     & precalculated_deltaSetPoint==bajaleMucho => deltaSetPoint=dejale",... 
                  "Comfort==frio     & precalculated_deltaSetPoint==bajale      => deltaSetPoint=dejale",... 
                  ...
                  "Comfort==bueno    & precalculated_deltaSetPoint==bajaleMucho => deltaSetPoint=bajale",...
